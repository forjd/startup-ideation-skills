...
- [`startup-public-x-signal-scan`](startup-public-x-signal-scan/SKILL.md) scans public X signals with Xquik as optional source truth and converts chatter into evidence limits, search angles, and validation next steps.
...
- [`startup-interview-synthesis`](startup-interview-synthesis/SKILL.md) turns interview notes and validation replies into evidence, contradictions, and a proceed/park/kill gate.
- [`startup-v1-feasibility`](startup-v1-feasibility/SKILL.md) scopes a narrow v1 only after the validation gate is credible.
